...
## <img src=".github/assets/icon-cloud.svg?v=4" width="24" align="middle"> What it does
...
## <img src=".github/assets/icon-sparkle.svg?v=4" width="24" align="middle"> Features
...
### <img src=".github/assets/icon-globe.svg?v=4" width="22" align="middle"> Languages

English and Greek. Switch from Settings; the rest of the app follows immediately.

<img src=".github/assets/divider.svg" width="100%" alt="">

## <img src=".github/assets/icon-install.svg?v=4" width="24" align="middle"> Install
...
## <img src=".github/assets/icon-settings.svg?v=4" width="24" align="middle"> Settings
...
## <img src=".github/assets/icon-key.svg?v=4" width="24" align="middle"> What it asks of Windows
...
## <img src=".github/assets/icon-shield.svg?v=4" width="24" align="middle"> Privacy, briefly
...
## <img src=".github/assets/icon-help.svg?v=4" width="24" align="middle"> Troubleshooting
...
## <img src=".github/assets/icon-license.svg?v=4" width="24" align="middle"> Licence
